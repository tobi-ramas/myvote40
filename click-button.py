...
mobile_user_agent = "Mozilla/5.0 (Linux; Android 10; V2025) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/83.0.4103.106 Mobile Safari/537.36"
...
try:
    ...
    driver.add_cookie({'name': 'PHPSESSID', 'value': '03104acfd2a85cf27f95728ad766ef8b'})
    time.sleep(2)
    # to refresh the page
    driver.refresh()
